...
public class Insert_jobpost_for_carpentor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insert_jobpost_for_carpentor);
        ...
        mJobPost= FirebaseDatabase.getInstance().getReference().child("Job Post For Carpentor").child(uId);
